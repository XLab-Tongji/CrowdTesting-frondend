<template>
  <el-container>
    ...
    <el-main>
      ...
      <el-row type="flex" justify="center" style="margin-top:6vh" gutter="40">
        <el-col :span="3" style="text-align: center;font-size:1.3vw;font-weight:500;letter-spacing: 0.2vh;color:#ffffff;border-radius:4px;background-color:#ffffff">
